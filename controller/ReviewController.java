...
public class ReviewController {
    ...
    public ResponseEntity<Map<String, String>> addReview(
        ...
        try {
            ...
            return new ResponseEntity<>(Map.of("message", "Review added successfully"), HttpStatus.CREATED);
        } catch (Exception e) {
            // 에러 발생 시 에러 메시지를 반환.
            return new ResponseEntity<>(Map.of("message", "Failed to add review: " + e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
